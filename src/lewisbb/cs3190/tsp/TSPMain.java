...
//			System.out.println(rdmtsp.solution(rdmtsp.route, 1000));
//			System.out.println("Two opt solution:");
//			TwoOptTSPSolution twoopttsp = new TwoOptTSPSolution(inputFile);
//			System.out.println(twoopttsp.solution(rdmtsp.route, 1000));
			...
			SolutionTuple solution = aistsp.solution((long) 1000, 10.0);
